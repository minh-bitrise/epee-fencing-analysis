...
The system is supported by 760 automated tests: 438 over the pipeline, 187 over the application
layer and 135 over the interface, plus two end-to-end tests driving the real pipeline on a
