...
The system is supported by 777 automated tests: 440 over the pipeline, 191 over the application
layer and 146 over the interface, plus two end-to-end tests driving the real pipeline on a
