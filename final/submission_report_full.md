...
The system is supported by 770 automated tests: 438 over the pipeline, 191 over the application
layer and 141 over the interface, plus two end-to-end tests driving the real pipeline on a
