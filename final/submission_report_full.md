...
The system is supported by 773 automated tests: 440 over the pipeline, 191 over the application
layer and 142 over the interface, plus two end-to-end tests driving the real pipeline on a
